...
object Hightlight {
  ...
  private fun isIdentNext(c: Char): Boolean {
    return QuickjsJni.jsIsIdentNext(c.toInt())
  }

  private fun isIdentFirst(c: Char): Boolean {
    return QuickjsJni.jsIsIdentFirst(c.toInt())
  }
